...
<div class="messaging">
      <div class="inbox_msg">
        <div class="inbox_header">
          <div class="col-12 hidden-sm text-right">
          <li class="btn" style="float: right;"><i class='fas fa-ellipsis-h'></i></li>
          <li class="btn" style="float: right;"><i class='fas fa-phone-alt'></i></li>
          <li class="btn" style="float: right;"><i class='fas fa-video'></i></li>
          </div>
        </div>
